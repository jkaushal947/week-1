/* ----------------------------------------------------------------------------
    ...
    THE CASE STUDY JAVASCRIPT FILE
...
$("#mainMenu li").click(function () {
    ...
    if ($(window).width() < 1024) {
        ...
        $("span.navBtn").click(); /* This line we are doing a call back function */
    }
});
...
(function () {
    ...
    var myParallax = document.querySelectorAll(".homeBgImage"),
        speed = 0.3;
